...
function addrealme(){
    let item = {name:'Acer Laptop', price:30000}
    products.push(item);
...
function addredmi(){
    let item = {name:'HP Laptop', price:50000}
    products.push(item);
    localStorage.setItem("items", JSON.stringify(products));
    updateCart();
}
...
function addsamsung(){
    let item = {name:'Lenovo Laptop', price:40000}
    products.push(item);
    localStorage.setItem("items", JSON.stringify(products));
    updateCart();   
}
...
function addoppo(){
    let item = {name:'Apple Laptop', price:150000}
    products.push(item);
    localStorage.setItem("items", JSON.stringify(products));
    updateCart();
}
